...
const Config = {
	...
	torrentEngineOpts: {uploads: 0, connections: 30, tmp: path.join(os.tmpdir(),path.sep), path: path.join('/tmp',os.userInfo().username, 'sgoinfre', path.sep) }
};
